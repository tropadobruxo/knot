...
export function CompatibilityCard({ compatibility }: { compatibility: Compatibility }) {
  ...
  return (
    <div className="mt-6 rounded-2xl border border-zinc-200/80 bg-white p-4 shadow-sm dark:border-zinc-800/80 dark:bg-zinc-900/60">
      ...
      <div className="mt-2 flex flex-wrap gap-1.5">
        {activeItems.map((item) => (
          <span
            key={item.label}
            className="flex items-center gap-1 rounded-full border border-zinc-200 bg-zinc-50 px-2.5 py-1 text-xs font-medium text-zinc-700 dark:border-zinc-700/70 dark:bg-zinc-800/60 dark:text-zinc-300"
          >
